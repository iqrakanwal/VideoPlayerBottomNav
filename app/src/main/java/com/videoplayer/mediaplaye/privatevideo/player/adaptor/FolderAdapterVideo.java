...
public class FolderAdapterVideo extends RecyclerView.Adapter<FolderAdapterVideo.ItemHolder> {

    Activity context;
    private ArrayList<FolderItem> folderItems = new ArrayList<>();
    public FolderAdapterVideo(Activity context) {
    ...
    public void onBindViewHolder(@NonNull ItemHolder itemHolder, int i) {
        ...
        itemHolder.container.setOnClickListener(v -> {
            ...
            activity.getSupportFragmentManager().beginTransaction().replace(R.id.fameforspeed, myFragment).addToBackStack(null).commit();
