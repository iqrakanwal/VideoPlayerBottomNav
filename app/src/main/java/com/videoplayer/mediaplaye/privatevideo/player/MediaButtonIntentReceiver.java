...
public class MediaButtonIntentReceiver extends BroadcastReceiver {
        ...
        public void handleMessage(final Message msg) {
            switch (msg.what) {
                case MSG_HEADSET_DOUBLE_CLICK_TIMEOUT:
                    ...
                    switch (clickCount) {
                        case 1:
                            command = VideoBackendService.TOGGLEPAUSE_ACTION;
                            break;
                        case 2:
                            command = VideoBackendService.NEXT_ACTION;
                            break;
                        case 3:
                            command = VideoBackendService.PREVIOUS_ACTION;
                            break;
                        default:
                            command = null;
                            break;
        ...
        if (Intent.ACTION_MEDIA_BUTTON.equals(intentAction)) {
            ...
            switch (keycode) {
                case KeyEvent.KEYCODE_MEDIA_STOP:
                    command = VideoBackendService.STOP_ACTION;
                    break;
    ...
    private static void startService(Context context, String command) {
        final Intent intent = new Intent(context, VideoBackendService.class);
        intent.setAction(VideoBackendService.SERVICECMD);
        intent.putExtra(VideoBackendService.CMDNAME, command);
