...
if(!setupDone)
    ...
    public void In_app()
    {
        String base64EncodedPublicKey="";
        ...
        mPurchaseFinishedListener = new IabHelper.OnIabPurchaseFinishedListener() {
            @Override
            public void onIabPurchaseFinished(com.ebookfrenzy.inappbilling.util.IabResult result, com.ebookfrenzy.inappbilling.util.Purchase purchase) {
                if (result.isFailure())
                {
