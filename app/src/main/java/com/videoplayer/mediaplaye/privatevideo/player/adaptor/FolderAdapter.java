...
public class FolderAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FolderAdapter(Activity context, musiclistener musiclistener1) {
        this.context = context;
        this.musiclistener = musiclistener1;
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder itemHolder1, int i) {
        ...
        if (itemHolder1.getItemViewType() == CONTENT_TYPE) {
            ...
            //itemHolder.checkBox.setChecked(folderItem.getSelected());

//            if (context.is_in_action_mode) {
//                VideoAdapter.Anim anim = new VideoAdapter.Anim(100, itemHolder.linear);
//                anim.setDuration(300);
//                itemHolder.linear.setAnimation(anim);
//                itemHolder.imageViewOption.setVisibility(View.GONE);
//            } else {
//
//                VideoAdapter.Anim anim = new VideoAdapter.Anim(0, itemHolder.linear);
//                anim.setDuration(300);
//                itemHolder.linear.setAnimation(anim);
...
//                itemHolder.checkBox.setChecked(folderItems.get(i).getSelected());
//            }
//            itemHolder.checkBox.setTag(folderItems.get(i));
           itemHolder.folderSize.setText(folderItem.getVideoItems().size() + "");
//            itemHolder.checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
//                @Override
//                public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
//
//                    if (isChecked) {
//                        FolderItem fruits1 = (FolderItem) itemHolder.checkBox.getTag();
//                        fruits1.setSelected(itemHolder.checkBox.isChecked());
//                        folderItems.get(i).setSelected(itemHolder.checkBox.isChecked());
//
//
//                    } else if (!isChecked) {
//
    ...
    public class ItemHolder extends RecyclerView.ViewHolder {
       ...
       // CheckBox checkBox;
        ...
        public ItemHolder(View view) {
            ...
            this.option = view.findViewById(R.id.folderoption);
